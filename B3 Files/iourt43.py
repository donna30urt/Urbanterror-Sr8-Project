...
class Iourt43Parser(Iourt41Parser):
    ...
    def getServerTeam(self, client):
        serverteam = self.write("getteam %s" % client.cid)
        if serverteam == "0":
            return b3.TEAM_FREE
        elif serverteam == "1":
            return b3.TEAM_RED
    ...
    def OnClientuserinfochanged(self, action, data, match=None):
        ...
        if parseddata:
            ...
            if client:
                ...
                # Now update the team ourselves
                serverTeam = self.getServerTeam(client)
                setattr(client, 'team', serverTeam)
